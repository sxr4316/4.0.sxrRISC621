//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" LPM_REPRESENTATION="SIGNED" LPM_WIDTHA=12 LPM_WIDTHB=12 LPM_WIDTHP=13 MAXIMIZE_SPEED=5 dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
module  mult_u0n
	...
	wire signed	[11:0]    dataa_wire;
	wire signed	[11:0]    datab_wire;
	wire signed	[23:0]    result_wire;
	...
	assign result = ({result_wire[23:11]});
